...
MiniGameComponent::MiniGameComponent(const World* aWorld)
{
	...
	myMusicRoomMiniGame = new MusicRoomMiniGame(MG_MUSIC_ROOM, aWorld->GetRoomByID(MUSIC_ROOM));
	...
	myMiniGames.push_back(myMusicRoomMiniGame);
