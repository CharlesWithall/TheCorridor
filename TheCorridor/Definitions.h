...
#define INVALID_NOTE_STRING "You cannot play that note; the keys are labelled A - G"
...
// ENUMS
enum Action { GO, LOOK, TAKE, EXAMINE, IGNITE, MOVE, ROTATE, PULL, USE, OPEN, PLAY, ACTION_COUNT, INVALID_ACTION };
...
enum ItemID { INFERNO, PURGATORIO, PARADISUM, GOULAINE, RICASOLI, CODORNIU, BUCKET, BLUE_KEY, GREEN_KEY, PURPLE_KEY, RED_KEY, YELLOW_KEY, MAP, MATCHBOX, NOTE, POKER, STAFF, BLACK_KEY, IVORY_KEY,
			FIREPLACE = 117, PIPES, TILES, CANDELABRA, FONT, BOOKCASE, WINERACK, CHEST, BOX, TAPESTRY, RUBBLE, PAINTING, HERMIT, JUDITH, DAVID, SALOME, DOOR, PIANO, ITEM_INVALID };
enum MiniGameID { MG_BOOKS, MG_CHANDELIERS, MG_CHESSBOARD, MG_WATERPIPES, MG_MUSIC_ROOM };
enum RoomID { CORRIDOR_ONE, CORRIDOR_TWO, CORRIDOR_THREE, CORRIDOR_FOUR, CORRIDOR_FIVE, CORRIDOR_SIX, CORRIDOR_SEVEN,
			DRAWING_ROOM, LIBRARY, SECRET_ROOM, TREASURY, WINERY, BATHROOM, PLAYROOM, COURTYARD, CORRIDOR_EIGHT, MUSIC_ROOM, INVALID_ROOM }; // !!! KEEP SYNCHRONISED WITH room_data.xml !!!
